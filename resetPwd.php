...
<head>
    ...
    <!-- Title -->
    <title> bySolitdio - Reset Password </title>
...
<body>
            ...
            <section class="mt-60 mb-60">
                <div class="container">
                    <div class="sign widget ">
                        ...
                        <form action="#" class="sign-form widget-form " id="resetPwdForm" method="post">
                            <?php
                            ...
                            ?>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" id="resetPwd" placeholder="New password" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="password" class="form-control" id="resetPwd-repeat" placeholder="Confirm password" required>
                                        </div>

                                        <div class="form-group">
                                            <button type="submit" class="btn-custom" id="resetPwdSubmit">Reset Password</button>
                                        </div>
    ...
    <script src="customJS/resetPwd.js?v='<?php echo time(); ?>'"></script>

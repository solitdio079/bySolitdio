...
<body>
            ...
            <section class="mt-60 mb-60">
                <div class="container">
                    <div class="sign widget ">
                        ...
                        <form action="#" class="sign-form widget-form " id="loginForm" method="post">
                            <div class="form-group">
                                <input type="email" class="form-control" placeholder="Email*" id="email" value="" required>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Password*" id="pwd" name="password" value="" required>
                            </div>
                            <div class="sign-controls form-group">
                                ...
                                <a href="forgotPwd.php" class="btn-link  ml-auto">Forgot Password?</a>
                            </div>
                            <div class="form-group">
                                <button type="submit" class="btn-custom" id="loginSubmit">Login now</button>
                            </div>
    ...
    <script src="./customJS/login.js?v='<?php echo time(); ?>'"></script>
